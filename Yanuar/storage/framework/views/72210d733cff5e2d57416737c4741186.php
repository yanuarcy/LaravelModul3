...
<body>
    <div class="container m-5">
        ...
        <div class="list-group list-group-numbered mt-4">
            ...
            <a href="<?php echo e(url('/title/this_is_my_title')); ?>" class="list-group-item list-group-item-action">
                Route With Regular Expression Constraints
            </a>
            <a href="<?php echo e(route('profileRouteName', ['profileId' => '134'])); ?>" class="list-group-item list-group-item-action">
                Named Route
            </a>
...
<?php /**PATH C:\Users\Lenovo\Documents\Semester 4\Yanuar\resources\views/routing.blade.php ENDPATH**/ ?>